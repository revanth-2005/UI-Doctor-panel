# ================================================
# Individual Curl Commands for Creating Default Recipes
# Use these commands one by one to create recipes in the database
# ================================================
...
curl -X POST https://aroma-db-six.vercel.app/api/admin/recipes \
...
$recipe1 = @{
  ...
  conditionTag = "Diabetes Type 2"
  nutritionInfo = @{
    calories = 295; protein = 35; carbs = 12; fat = 15; fiber = 4; sugar = 6
  }
  estimatedTime = 25
  difficulty = "Easy"
  servings = 2
...
Invoke-RestMethod -Uri "https://aroma-db-six.vercel.app/api/admin/recipes" -Method POST -Headers @{"Content-Type"="application/json"} -Body $recipe1

# ====================
# Verification Commands
# ====================

# Check if recipes were created successfully:
curl https://aroma-db-six.vercel.app/api/admin/recipes

# Or with PowerShell:
Invoke-RestMethod -Uri "https://aroma-db-six.vercel.app/api/admin/recipes" -Method GET